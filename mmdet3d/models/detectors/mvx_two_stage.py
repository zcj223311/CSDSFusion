...
class MVXTwoStageDetector(Base3DDetector):
    ...
    def __init__(self,
                 ...
                 pre_fusion_encoder=None,
                 pseudo_pts_middle_encoder=None,
                 multimodal_middle_encoder=None,
                 virtual_pts_encoder=None,
                 lidar_img_encoder=None,
        ...
        if pts_middle_encoder:
            self.pts_middle_encoder = builder.build_middle_encoder(
                pts_middle_encoder)
        if lidar_img_encoder:
            self.lidar_img_encoder = builder.build_middle_encoder(
                lidar_img_encoder)
        if virtual_pts_encoder:
            self.virtual_pts_encoder = builder.build_middle_encoder(
                virtual_pts_encoder)
        ...
        if pre_fusion_encoder:
            self.pre_fusion_encoder = builder.build_middle_encoder(
                pre_fusion_encoder)
        if pts_backbone:
